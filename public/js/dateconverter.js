...
function bs2ad(date) {
  return `${offsetADDays(countBSDays(date)).year}-${offsetADDays(countBSDays(date)).month}-${offsetADDays(countBSDays(date)).day}`;
}

function ad2bs(date) {

return  `${offsetBSDays(countADDays(date)).en.year}/${offsetBSDays(countADDays(date)).en.month}/${offsetBSDays(countADDays(date)).en.day}`;
