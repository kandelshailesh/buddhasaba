...
$.ajax({
	...
	success:function(data)
	{
		...
		$('div.displayledgertable').html('');
		$('div.displayledgertable + p').remove();

		$('div.totaldc').html('');

		if ( Array.isArray(data.result) && data.result.length) 
		{
		$('div.displayledgertable').append(`
	...
	$('div#displayledger').append(`<p class="text-center" style="color:red;">डाटा उपलब्ध भएन</p>`);	
	}
