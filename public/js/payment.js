...
for (var i = 1; i < 2; i++) {
    ...
    $('.paymenttable').append(`<tr  class=" m-0 row text-center">
      ...
      <td   class="col-md-2 p-0"><input onkeypress="createnew(event)" oninput="javascript:checktotaldc(event);" name="credit" id="credit-${i}"  type="number" min="0" class="form-control" disabled/></td>
    </tr>`)
}
